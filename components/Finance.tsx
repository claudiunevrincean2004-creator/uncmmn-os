...
export default function Finance({ clients, monthlyRevenue, monthlyExpenses, clientExpenses, clientMonthExclusions, onReload, onOpenSidebar }: Props) {
  ...
  function computeTotals(months: string[]) {
    ...
    return { totalRevenue, totalExpenses: grandTotalExpenses, netProfit: realNetProfit, margin: realMargin, grossProfit, grossMargin, taxDividends, taxEntries, clientBreakdown, expenseCategories, allExpenses: opExpenses, operationalExpenses, totalClientExpenses: totalClientExp };
  }
